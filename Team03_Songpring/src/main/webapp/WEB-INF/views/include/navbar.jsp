...
<div class="container">
			...
			<div class="navbar-nav" style="width: 100%;">
				<table style="width: 100%;">
					<tr>
						...
						<td align = "center"><small><a class="nav-link" href="${pageContext.request.contextPath }/users/loginform.jsp">
							<c:choose>
								<c:when test="${empty sessionScope.id }">로그인</c:when>
	...
	<div class="row" style="margin-top: 20px; margin-bottom: 20px; border: 0px solid white;">
